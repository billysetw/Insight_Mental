               ...
               <div class="card">
                  <div class="card-body">
                    ...
                    <label>Category</label>
                        <input type="text" id="category" name="category" placeholder="Silahkan masukkan category...">

                        <label>Title</label>
                        <input type="text" id="title" name="title" placeholder="Silahkan masukkan title...">

                        <label>Singer</label>
                        <input type="text" id="singer" name="singer" placeholder="Silahkan masukkan singer...">
                        
                        <label>Photo Album</label><br>
                        <input type="file" id="PhAl" name="phAl"><br><br>
                        ...
                        <button type="button" class="btn-back btn btn-primary" name="back"><a href="musics.php" onclick="return confirm('Anda yakin ingin Kembali?')">Back</a></button>
                    </form>
                    </div>
                  </div>
               </div>
